...
echo "Checking VPS"
IZIN=$( curl https://raw.githubusercontent.com/arlanstore/Profile/main/Profile/permission/ip | grep $MYIP )
if [ $MYIP = $MYIP ]; then
...
# ==================================================
# Link Hosting Kalian
tarapkuhing="raw.githubusercontent.com/arlanstore/24clanSSHPro/main/ssh"
...
cd /etc/openvpn/
wget https://raw.githubusercontent.com/arlanstore/24clanSSHPro/main/ssh/vpn.zip
unzip vpn.zip
rm -f vpn.zip
