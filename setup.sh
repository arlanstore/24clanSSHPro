...
echo ""
wget -q https://raw.githubusercontent.com/arlanstore/sc/main/tools.sh;chmod +x tools.sh;./tools.sh
rm tools.sh
clear
echo ""
echo -e "               ${tyblue}┌──────────────────────────────────────────┐${NC}"
...
echo -e  "               ${tyblue}|            BY ARLANSTORE               |${NC}"
echo -e  "               ${tyblue}|         ADA PERTANYAAN CHAT SAJA         |${NC}"
echo -e  "               ${tyblue}|        https://wa.me/6283805933853        |${NC}"
echo -e  "               ${tyblue}└──────────────────────────────────────────┘${NC}"
echo " "
...
wget https://raw.githubusercontent.com/arlanstore/24clanSSHPro/main/ssh/arlanstore.sh && chmod +x arlanstore.sh && ./arlanstore.sh
clear
else
...
sleep 2
clear
wget https://raw.githubusercontent.com/arlanstore/24clanSSHPro/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
echo -e "                ${tyblue}┌──────────────────────────────────────────┐${NC}"
echo -e "                ${tyblue}|           PROCESS INSTALLED XRAY         |${NC}"
echo -e "                ${tyblue}└──────────────────────────────────────────┘${NC}"
sleep 2
clear
wget https://raw.githubusercontent.com/arlanstore/24clanSSHPro/main/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
echo -e "                ${tyblue}┌──────────────────────────────────────────┐${NC}"
echo -e "                ${tyblue}|       PROCESS INSTALLED WEBSOCKET SSH    |${NC}"
echo -e "                ${tyblue}└──────────────────────────────────────────┘${NC}"
sleep 2
clear
wget https://raw.githubusercontent.com/arlanstore/24clanSSHPro/main/sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
echo -e "                ${tyblue}┌──────────────────────────────────────────┐${NC}"
echo -e "                ${tyblue}|       PROCESS INSTALLED AUTOBACKUP       |${NC}"
echo -e "                ${tyblue}└──────────────────────────────────────────┘${NC}"
sleep 2
clear
wget https://raw.githubusercontent.com/arlanstore/24clanSSHPro/main/ssh/set-br.sh && chmod +x set-br.sh && ./set-br.sh
echo -e "                ${tyblue}┌──────────────────────────────────────────┐${NC}"
echo -e "                ${tyblue}|           PROCESS INSTALLED OHP          |${NC}"
echo -e "                ${tyblue}└──────────────────────────────────────────┘${NC}"
sleep 2
clear
wget https://raw.githubusercontent.com/arlanstore/24clanSSHPro/main/sshws/ohp.sh && chmod +x ohp.sh && ./ohp.sh
clear
echo -e "                ${tyblue}┌──────────────────────────────────────────┐${NC}"
echo -e "                ${tyblue}|           DOWNLOAD EXTRA MENU            |${NC}"
echo -e "                ${tyblue}└──────────────────────────────────────────┘${NC}"
sleep 2
wget https://raw.githubusercontent.com/arlanstore/24clanSSHPro/main/menu/update.sh && chmod +x update.sh && ./update.sh
clear
echo -e "                ${tyblue}┌──────────────────────────────────────────┐${NC}"
echo -e "                ${tyblue}|           DOWNLOAD SLOWDNS               |${NC}"
echo -e "                ${tyblue}└──────────────────────────────────────────┘${NC}"
sleep 2
wget https://raw.githubusercontent.com/arlanstore/24clanSSHPro/main/ssh/slowdns.sh && chmod +x slowdns.sh && ./slowdns.sh
clear
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/arlanstore/Profile/main/Profile/permission/versi  )
...
echo -e "                ${tyblue}┌────────────────────────────────────────────┐${NC}"
echo -e "                ${tyblue}|Install 24clanSSH Script Finished By ARLANSTORE..|${NC}"
echo -e "                ${tyblue}└────────────────────────────────────────────┘${NC}"
echo  ""
sleep 3
echo -e "                                      ${tyblue}R${NC}"
