...
Isadmin=$(curl -sS https://raw.githubusercontent.com/arlanstore/Profile/main/Profile/permission/ip  | grep $MYIP | awk '{print $5}')
...
Exp=$(curl -sS https://raw.githubusercontent.com/arlanstore/Profile/main/Profile/permission/ip  | grep $MYIP | awk '{print $3}')
fi
...
wget -qO- https://raw.githubusercontent.com/arlanstore/Profile/main/Profile/permission/bot-api.sh >/etc/.maAsiss/.Shellbtsss
}
