...
wget -q -O /usr/bin/m-bot "https://raw.githubusercontent.com/arlanstore/24clanSSHPro/main/menu/m-update.sh" && chmod +x /usr/bin/m-bot

sleep 2
echo -e "$COLOR1│${NC}  $COLOR1[INFO]${NC} Download Changelog File"
wget -q -O /root/changelog.txt "https://raw.githubusercontent.com/arlanstore/24clanSSHPro/main/menu/changelog.txt" && chmod +x /root/changelog.txt
